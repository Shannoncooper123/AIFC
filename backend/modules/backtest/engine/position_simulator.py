...
class PositionSimulator:
    ...
    def _save_position_data(self, pos) -> Dict[str, Any]:
        ...
        return {
            ...
            "agent_side": getattr(pos, 'agent_side', None),
            "agent_tp_price": getattr(pos, 'agent_tp_price', None),
            "agent_sl_price": getattr(pos, 'agent_sl_price', None),
    ...
    def _create_trade_result(
        ...
        trade_result = BacktestTradeResult(
            ...
            agent_side=saved_data.get("agent_side"),
            agent_tp_price=saved_data.get("agent_tp_price"),
            agent_sl_price=saved_data.get("agent_sl_price"),
            limit_price=limit_price,
