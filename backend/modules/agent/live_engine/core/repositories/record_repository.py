...
class RecordRepository:
    ...
    def _save_state(self):
        ...
        for callback in self._on_change_callbacks:
            try:
                ...
                logger.error(f"[RecordRepository] 回调失败: {e}")
    ...
    def get_closed_records(self, source: Optional[str] = None, limit: int = 100) -> List[TradeRecord]:
        """获取已关闭记录
    ...
    def count(self, source: Optional[str] = None, status: Optional[RecordStatus] = None) -> int:
        """统计记录数量"""
        with self._lock:
