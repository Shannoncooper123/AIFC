    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <div className="text-xs text-slate-500 mt-1 font-mono">{runId}</div>
        </div>
        <div
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
        ...
        <div>
          <div className="text-slate-400">总耗时</div>
          <div className="text-white mt-1">
            {formatDuration(timeline.duration_ms)}
          </div>
        </div>
        <div>
          <div className="text-slate-400">节点数</div>
          <div className="text-white mt-1">{timeline.spans.length}</div>
        </div>
        <div>
          <div className="text-slate-400">图像数</div>
      ...
      {uniqueSymbols.length > 0 && (
        <div className="mt-4">
          <div className="text-slate-400 text-sm mb-2">币种筛选</div>
