...
from agent.trade_simulator.models import PendingOrder
...
class LimitOrderManager:
    ...
    def create_limit_order(
        ...
        with self.lock:
            ...
            if leverage < 1 or leverage > 125:
                ...
                return {"error": "TOOL_INPUT_ERROR: leverage需在1..125"}
    ...
    def persist(self) -> None:
        """持久化所有待成交的限价单到文件"""
        try:
            from agent.trade_simulator.utils.file_utils import TaskType
